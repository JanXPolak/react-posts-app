...
const ListSorter:FC<Props> = ({ onChangeSorting }) => {
  return (
    ...
    <p className="text-sm font-medium text-gray-700">Sortuj:</p>
    <select
    ...
    >
      <option value={SortOption.alphabetically}>Alfabetycznie</option>
      <option value={SortOption.newest}>Najnowsze</option>
      <option value={SortOption.oldest}>Najstarsze</option>
    </select>
  </div>
  )
}
